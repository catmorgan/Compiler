 ...
 */
/**
 * The CharStream class reads a text file and presents "significant" characters
 * one at a time via the
 * <code>currentChar()</code> method. Comments are ignored (treated as
 * white-space) and multiple white-space characters are treated as a single
 * space character.
 *
 * When the CharStream has reached end of the file the
 * <code>currentChar()</code> method will return
 * <code>CharStream.EOF</code>.
 */
public class CharStream {
    ...
    /**
     * Character returned when end of file is reached. This is also the value
     * that
     * <code>BufferedReader.read()</code> returns when it reaches the end of
     * file.
     */
    ...
    /**
     * The stack used to put back characters onto
     */
    ...
    /**
     * Returns the number of the line currently being scanned. Returns 0 (zero)
    ...
    /**
     * Returns a character to the stream. The character returned to the stream
     * will be the next character returned by the
     * <code>currentChar<></code> method.
     */
    ...
    /**
     * Returns true if the character ch is allowed to appear in a source file.
    ...
    /**
     * Returns the next character from the file, or CharStream.EOF if the end of
    ...
    /**
     * Skips over consecutive white space characters. Comments are treated as
     * white space.
     */
    ...
    /**
     * Reads a character from the source file. If an IOException occurs during
     * the read an EOF will be returned.
     */
